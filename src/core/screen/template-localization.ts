import { TemplateTextTranslation } from '@bitzonegaming/roleplay-engine-sdk';
import { TemplateConfigTranslation } from '@bitzonegaming/roleplay-engine-sdk/localization/models/localization';
